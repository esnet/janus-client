...
class AuthInfoResponse(BaseModel):
    ...
    AuthInfoResponse
    """ # noqa: E501
    groups: Optional[List[StrictStr]] = Field(default=None, description="List of authorized groups")
    users: Optional[List[StrictStr]] = Field(default=None, description="List of authorized users")
