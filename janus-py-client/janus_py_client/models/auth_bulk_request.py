...
class AuthBulkRequest(BaseModel):
    ...
    identifiers: List[IdentifiersInner] = Field(description="List of resource names or IDs")
    remove: Optional[StrictBool] = Field(default=None, description="If true, remove these users/groups instead of adding them")
    resource: StrictStr = Field(description="Resource type")
    users: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["groups", "identifiers", "remove", "resource", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identifiers": [IdentifiersInner.from_dict(_item) for _item in obj["identifiers"]] if obj.get("identifiers") is not None else None,
