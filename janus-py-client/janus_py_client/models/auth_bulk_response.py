...
class AuthBulkResponse(BaseModel):
    ...
    AuthBulkResponse
    """ # noqa: E501
    resource: StrictStr = Field(description="Resource type updated")
    results: List[Dict[str, Any]] = Field(description="List of individual update results")
    __properties: ClassVar[List[str]] = ["resource", "results"]
