...
from janus_py_client.api_response import ApiResponse, T as ApiResponseT
import janus_py_client.models
from janus_py_client import rest
from janus_py_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(janus_py_client.models, klass)
